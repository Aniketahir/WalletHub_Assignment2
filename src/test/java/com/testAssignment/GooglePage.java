...
public class GooglePage {
	...
	public void openGmail() throws Exception {
		...
		Thread.sleep(3000);
		// wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@title='Google apps']")));
		WebElement googleAppIcon = driver.findElement(By.xpath("//a[@title='Google apps']"));
		googleAppIcon.click();
 ...
 System.out.println(urlLink+" - "+httpConn.getResponseMessage());
	 ...
	 System.out.println("Response code is unknown"+httpConn.getResponseCode());
 }
        }
